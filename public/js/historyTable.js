...
function createNewRow(productData) {
  ...
  newRow.innerHTML = `
    ...
    <td data-label="سعر البيع">${productData["سعر البيع"]} ج</td>
    <td data-label="الكمية">
      <input type="number" class="quantityInput form-control input-number text-center" style="min-width: 50px;" value="${getInitialQuantity(
        productData.الكود
      )}" min="1"/>
    </td>
