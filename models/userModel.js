...
const userSchema = new mongoose.Schema({
  ...
  username: {
    ...
    lowercase: true,
    maxLength: [15, "A username must have less than or equal 15 characters"],
    minLength: [3, "A username must have more than or equal 3 characters"],
  },
  email: {
    type: String,
  ...
  role: {
    type: String,
    enum: ["customer", "user", "cashier", "admin"],
    default: "user",
  },
  password: {
    type: String,
